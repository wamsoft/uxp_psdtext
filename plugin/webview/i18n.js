...
const DICT = {
	ja: {
		...
		'style.align.right':  '右',
		'style.note':      'フォントはファミリ名で検索して一覧から選ぶ。手入力なら PostScript 名も通る。',
		'style.apply':     '適用',
	...
	en: {
		...
		'style.note':      'Search fonts by family name and pick from the list; typing a PostScript name directly also works.',
		'style.apply':     'Apply',

...
const DICT = {
	ja: {
		...
		'fmt.hint':        '本文で範囲を選択してから',
		'fmt.needSel':     '本文の範囲を選択してから押してください',
		'fmt.noRich':      'このレイヤは部分書式を読み込めませんでした (プレーン編集のみ)',
		'edit.working':    '処理中…',
		...
		'style.align.right':  '右',
		'style.note':      'フォント欄の候補は、お気に入りとこのドキュメントで使用中のものだけ。お気に入りの登録は隣の ★ ボタンから (全フォントを検索できる)。',
		'style.apply':     '適用',
	...
	en: {
		...
		'fmt.hint':        'Select part of the body first',
		'fmt.needSel':     'Select part of the body first',
		'fmt.noRich':      'Per-range formatting could not be read for this layer (plain editing only)',
		...
		'style.note':      'The font field lists only favorites and the fonts used in this document. Register favorites with the ★ button next to it (searches all fonts).',
		'style.apply':     'Apply',

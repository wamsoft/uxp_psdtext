...
const DICT = {
	ja: {
		...
		'sheet.fontAll':   '全行のフォント',
		'sheet.fontAllSet': '全行に設定',
		'sheet.fontAllSet.title': '表の全行の基準フォントをこれにする。適用時、基準と同じフォントだった範囲だけが追随し、本文途中で別フォントを指定した箇所はそのまま残る',
		'sheet.fontAllDone': '{0} 行の基準フォントを変えました',
		'sheet.fontAllNone': 'フォントを選んでください',
	...
	en: {
		...
		'sheet.fontAll':   'Font for every row',
		'sheet.fontAllSet': 'Set on every row',
		'sheet.fontAllSet.title': 'Set the base font of every row in the table. On apply, only runs that matched the old base font follow; a font set partway through the body stays as it is',
		'sheet.fontAllDone': 'Base font changed on {0} row(s)',
		'sheet.fontAllNone': 'Pick a font first',
